export default {
  sections: [
    ...
    },
    {
      ...
      lead: "As a Swiss by choice living in Le Locle, our national artist travels all around Switzerland. His trips are calculated from his home location and are exclusively reserved for the Swiss audience... for now!",
      action: "",
      url: "",
      media: {
        type: "image",
    ...
    {
      id: 9,
      header: "✍🏼 Analog Drawing",
      lead: "In just a few minutes, without any preparation, Pascal creates portraits in A3 or A4 format. The execution is lightning-fast and the work is instantly available. An easel, pencils, paper—turnkey drawings without the constraint of a digital setup!",
      action: "",
      url: "",
      media: {
        type: "image",
