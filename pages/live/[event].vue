			...
			<div class="grid grid-cols-[1fr,auto]">
				<section id="title" class="w-full p-4 sticky top-0 z-2 stretch-1">
					<h2 class="hidden md:block text-4xl font-extrabold" id="url-title">
						<NuxtLink to="/">
							<span
								class="hidden md:inline dark:text-primary-600 text-primary-800 hover:text-primary-900 dark:hover:text-primary-700 pe-1 leading-normal">
								coffez.ch
							</span> </NuxtLink
						>/live
					</h2>
					<div id="subtitle" class="flex text-center items-center gap-3">
						<UiCircleButton to="/" class="inline md:hidden">
							<IconsHome />
						</UiCircleButton>
						<h4 class="text-3xl font-light md:text-xl md:leading-tight" @click="">
							{{ settings?.title }}
						</h4>
					</div>
				</section>
