	...
	<NuxtLink
		...
		<div class="w-64">
			<div class="md:shrink-0">
				<div class="h-48 w-full object-cover dark:bg-zinc-500 font-2xl dark:text-white place-items-center grid">
					<Icon
						id="add-icon"
						name="ic:outline-add"
						class="w-2/3 h-2/3 dark:text-white text-primary-800 transition-transform duration-250 ease-in-out" />
				</div>
			</div>
			<div class="p-6">
...
#create-new-event:hover #add-icon {
	@apply rotate-90 dark:text-white;
}
</style>
